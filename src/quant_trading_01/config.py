...
FROZEN_PARAMS = [
    ...
    ("r5", "min_n", "池最小数"),
    ("r5", "min_ind", "行业最小数"),
    ("r5", "w_amihud", "Amihud 权重"),
    ("r5", "w_mom", "动量权重"),
    ("r5", "w_f4", "F4 权重"),
    ("r5", "limit_thr", "涨停阈值"),
    ("r5", "amihud_lookback", "Amihud 回看期"),
    ("r5", "amihud_min_periods", "Amihud 最小期数"),
    ("r5", "amihud_scale", "Amihud 放缩系数"),
    ("r5", "mom_short", "动量短窗"),
    ("r5", "mom_long", "动量长窗"),
    ("r5", "seasoning", "上市天数下限"),
    ("r5", "quantile", "分组数"),
