# screen02_factor_screen — 已归档探索

> 由 `research/archive_experiment.py` 于 2026-09-09 归档。
> 结论摘要与状态来自 plan §0 / README 探索表，以 plan 文档为准。

- **状态**：✅ 通过并入
- **结论摘要**：Round 2 批量筛选：Amihud 非流动性首个全通过因子（+7.3pp）
- **归档日期**：2026-09-09
- **相关脚本**：factor_screen_round2
- **plan 文档**：factor_screen_round2_plan.md
- **结论输出**：factor_screen_round2_summary.csv
