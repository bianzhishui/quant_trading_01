# etf_exploration — 已归档探索

> 由 `research/archive_experiment.py` 于 2026-09-09 归档。
> 结论摘要与状态来自 plan §0 / README 探索表，以 plan 文档为准。

- **状态**：⏸ 搁置
- **结论摘要**：ETF 动量/低波轮动与候选研究（独立方向，失败处置见 plan §0）
- **归档日期**：2026-09-09
- **相关脚本**：etf_candidates, etf_lowvol_replica, etf_momentum
- **plan 文档**：etf_momentum_plan.md
- **结论输出**：etf_lowvol_replica.png, etf_momentum.png
